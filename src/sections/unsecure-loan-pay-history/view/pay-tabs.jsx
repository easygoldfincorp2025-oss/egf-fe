      ...
      <Grid container spacing={3} sx={{ mt: 1.5 }}>
        ...
        <Grid item xs={12} P={0}>
          <Card sx={{ py: 0, px: 2 }}>
            ...
            {activeTab === 3 && currentLoan && (
              <LoanPartPaymentForm currentLoan={currentLoan} mutate={mutate} />
            )}
            {activeTab === 4 && currentLoan && (
              <LoanCloseForm currentLoan={currentLoan} mutate={mutate} />
            )}
          </Card>
        </Grid>
      </Grid>
