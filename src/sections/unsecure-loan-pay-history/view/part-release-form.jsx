...
import { useGetAllUnsecurePartRelease } from '../../../api/unsecure-part-release.js';
...
function PartReleaseForm({ currentLoan, mutate, configs }) {
  ...
  const { partRelease, refetchPartRelease } = useGetAllUnsecurePartRelease(currentLoan._id);
