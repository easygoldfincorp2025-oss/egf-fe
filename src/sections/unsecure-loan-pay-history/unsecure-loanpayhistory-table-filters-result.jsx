...
export default function UnsecureLoanpayhistoryTableFiltersResult({ filters, onFilters, onResetFilters, results, ...other }) {
...
UnsecureLoanpayhistoryTableFiltersResult.propTypes = {
