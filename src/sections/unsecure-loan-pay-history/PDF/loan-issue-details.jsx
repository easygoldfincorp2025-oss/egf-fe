              ...
              <View style={{ ...styles.flexContainer, gap: 10 }}>
                <View style={{ width: '60%' }}>
                  <View style={styles.row}>
                    ...
                    <Text style={styles.subText}>{selectedRow?.loanNo}/UL</Text>
                  </View>
                  <View style={styles.row}>
                    <Text style={styles.subHeading}>Loan Type</Text>
                    <Text style={styles.colon}>:</Text>
                    <Text style={styles.subText}>{`${selectedRow?.loanType} & Unsecure Loan`}</Text>
                  </View>
                  <View style={styles.row}>
                ...
                <View style={{ width: '35%' }}>
                  <View style={styles.row}>
                    ...
                    <Text style={styles.colon}>:</Text>
                    <Text style={styles.subText}>{selectedRow.loanAmount.toFixed(2)}</Text>
                  </View>
                  <View style={styles.row}>
                  ...
                  <View style={styles.row}>
                    <Text style={{ ...styles.subHeading, flex: 2.5 }}>Us Interest Rate</Text>
                    <Text style={styles.colon}>:</Text>
                    <Text style={styles.subText}>{1.25}%</Text>
                  </View>
                  <View style={styles.row}>
                  ...
                  <View style={{ marginTop: 20 }}>
                    ...
                    >
                      <View style={styles.row}>
                        ...
                        <Text style={styles.subText}>
                          {(
                            ((selectedRow?.scheme?.interestRate - 1).toFixed(2) / 1.25) *
                            (selectedRow?.loanAmount).toFixed(2)
                          ).toFixed(2) || '-'}
                        </Text>
                      </View>
                      <View style={styles.row}>
                        ...
                        <Text style={styles.subText}>
                          1.25%
                          {/*{selectedRow?.scheme*/}
                          {/*  ? `${(selectedRow?.scheme?.interestRate - 1).toFixed(2)}%`*/}
                          {/*  : '-'}*/}
                        </Text>
                      </View>
                    </View>
