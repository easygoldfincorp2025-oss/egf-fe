...
function UnsecureBulkInterestModel({ open, setOpen }) {
  const router = useRouter();
  const loanPayHistory = true;
  const { customer } = useGetCustomer();
  const { unSecureLoan } = useGetUnsecureLoan(loanPayHistory);
...
export default UnsecureBulkInterestModel;
