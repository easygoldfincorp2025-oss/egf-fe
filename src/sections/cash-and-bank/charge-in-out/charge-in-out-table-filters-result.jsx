...
export default function ChargeInOutTableFiltersResult({
  filters,
  onFilters,
  onResetFilters,
  results,
      ...
      <Stack flexGrow={1} spacing={1} direction="row" flexWrap="wrap" alignItems="center">
        ...
        {filters.chargeType.chargeType && (
          <Block label="Charge Type:">
            <Chip
              label={filters.chargeType.chargeType}
              size="small"
              onDelete={handleRemoveChargeType}
            />
          </Block>
        )}{' '}
        {filters.category && (
...
ChargeInOutTableFiltersResult.propTypes = {
