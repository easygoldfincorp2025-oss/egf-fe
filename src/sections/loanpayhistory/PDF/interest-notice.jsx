      ...
      <Document>
        <Page size="A4" style={styles.page}>
          ...
          <View style={styles.pagePadding}>
            ...
            <View>
              <Text style={styles.noticeTitle}>વિષય : ગોલ્ડ લોનનુ વ્યાજ ભરપાઈ કરવા બાબતે</Text>
            </View>
            <View style={styles.bottomDetails}>
              <Text style={styles.bottomDetails}>
                {' '}
                <Text>{'                     '}</Text>
                આથી જણાવવાનું કે તમે EASY GOLD FINCORP માંથી તારીખ{' '}
                ...
                જેમાં આપશ્રીએ કંપનીના નિયમોનુસાર રેગ્યુલર વ્યાજ ની ભરવાપાત્ર રકમ આજ દિન સુઘી ભરપાય
                કરેલ નથી. જેથી આપને આ નોટિસ આપવામાં આવે છે કે તારીખ{' '}
                <Text style={{ fontWeight: 'bold' }}>{fDate(date)}</Text> સુઘી માં આજ દિન સુઘી ની
                વ્યાજની બાકી રકમ નિયત મુંદત સુઘી માં વ્યાજ ની બાકી રકમ ભરપાય નહી કરે અથવા કંંપનીએ આપેલી
                મુદત સુઘી માં રૂબરૂ ઓફીસ પર હાજર ન થતા કંપની પોતાના નિયમોનુસાર વ્યાજ સાથેની બાકી{' '}
