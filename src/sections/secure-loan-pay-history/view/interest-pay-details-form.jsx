...
function InterestPayDetailsForm({ currentLoan, mutate, configs }) {
  ...
  useEffect(() => {
    ...
    setValue(
      'interestAmount',
      new Date(currentLoan.issueDate) < cutOffDate
        ? (
            (((currentLoan.interestLoanAmount *
        ...
        : (
            (((currentLoan.interestLoanAmount *
              (currentLoan?.scheme.interestRate > 1 ? 1 : currentLoan?.scheme.interestRate)) /
              100) *
              (12 * differenceInDays)) /
            365
          ).toFixed(2)
              ...
              {loanInterest.map((row, index) => (
                <>
                  <TableRow key={index} hover>
                    ...
                    >
                      {row?.loan?.scheme?.interestRate > 1 ? 1 : row?.loan?.scheme?.interestRate}
                    </TableCell>
                    <TableCell sx={{ py: 0, px: 2 }}>
                    ...
                    <TableCell sx={{ py: 0, px: 2 }}>{row.adjustedPay.toFixed(2)}</TableCell>
                    <TableCell sx={{ py: 0, px: 2 }}>{row.days}</TableCell>
                    <TableCell sx={{ py: 0, px: 2 }}>{fDate(row.createdAt)}</TableCell>
                    {/* <TableCell sx={{ py: 0, px: 2 }}> */}
                    {/*   {row.paymentDetail.cashAmount?.toFixed(2) || 0} */}
                    {/* </TableCell> */}
                    {/* <TableCell sx={{ py: 0, px: 2 }}> */}
                    {/*   {row.paymentDetail.bankAmount?.toFixed(2) || 0} */}
                    {/* </TableCell> */}
                    {/* <TableCell sx={{ py: 0, px: 2 }}> */}
