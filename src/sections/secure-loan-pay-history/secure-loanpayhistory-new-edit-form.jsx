  ...
  const defaultValues = useMemo(
    () => ({
      ...
      closedBy: currentLoan.closedBy
        ...
        : null,
      interest: new Date(currentLoan.issueDate) < cutoffDate ? (currentLoan?.scheme.interestRate > 1.5 ? 1.5 : currentLoan?.scheme.interestRate) : (currentLoan?.scheme.interestRate > 1 ? 1 : currentLoan?.scheme.interestRate),
      consultCharge: 0,
