...
import SecureLoanPayHistoryPdf from './PDF/secure-loan-pay-history-pdf.jsx';
...
export default function SecureLoanpayhistoryTableToolbar({ filters, onFilters ,loans}) {
        ...
        >
          ...
          <MenuItem>
            <RHFExportExcel
              ...
              fileName="Secure Loan Report"
              sheetName="SecureLoanReportSheet"
            />
          </MenuItem>
        </CustomPopover>
      </Stack>
...
SecureLoanpayhistoryTableToolbar.propTypes = {
