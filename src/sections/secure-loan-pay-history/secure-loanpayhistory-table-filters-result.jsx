...
export default function SecureLoanpayhistoryTableFiltersResult({ filters, onFilters, onResetFilters, results, ...other }) {
...
SecureLoanpayhistoryTableFiltersResult.propTypes = {
