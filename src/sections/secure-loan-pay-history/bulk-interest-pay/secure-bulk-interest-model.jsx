...
function SecureBulkInterestModel({ open, setOpen }) {
  const router = useRouter();
  const loanPayHistory = true;
  const { customer } = useGetCustomer();
  const { secureLoan } = useGetSecureLoan(loanPayHistory);
...
export default SecureBulkInterestModel;
