...
export default function OtherGoldLoanInterestListView({ interestDetail }) {
  ...
  const otherAmt = interestDetail.reduce(
            ...
            <Table size={table.dense ? 'small' : 'medium'}>
              ...
              <TableBody>
                {dataFiltered
                  ...
                  .map((row, index) => (
                    <OtherGoldLoanIntrestDetailseTableRow
                      key={row._id}
                      row={row}
                      index={index}
                ...
                >
                  ...
                  <TableCell sx={{ fontWeight: '600', color: '#637381', py: 1, px: 1 }}>
                    {(rate / interestDetail.length).toFixed(2)}
                  </TableCell>
                  <TableCell sx={{ fontWeight: '600', color: '#637381', py: 1, px: 1 }}></TableCell>
                  <TableCell sx={{ fontWeight: '600', color: '#637381', py: 1, px: 1 }}></TableCell>
                  <TableCell sx={{ fontWeight: '600', color: '#637381', py: 1, px: 1 }}>
                    {(day / interestDetail.length).toFixed(0)}
                  </TableCell>
                  <TableCell sx={{ fontWeight: '600', color: '#637381', py: 1, px: 1 }}>
