...
export default function DailyReportTableFiltersResult({
  filters,
  onFilters,
  onResetFilters,
  results,
  ...
  return (
    <Stack spacing={1.5} {...other}>
      ...
      <Stack flexGrow={1} spacing={1} direction="row" flexWrap="wrap" alignItems="center">
        ...
        {!!filters.username && (
          <Block label="username:">
            <Chip label={filters.username} size="small" onDelete={handleRemoveUsername} />
          </Block>
        )}
        <Button
          color="error"
...
DailyReportTableFiltersResult.propTypes = {
